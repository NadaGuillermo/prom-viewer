...
//   resource: any,
// ): GlobalTypes.Result<NormalizedFHIR.Bundle> => {
//   const issues: GlobalTypes.DataIssue[] = [];

//   const bundleQuestionnaireEntry = resource.entry.find(
//     (e: any) => e.resource?.resourceType === "Questionnaire",
//   );
//   const bundleQuestionnaireResponseEntry = resource.entry.find(
//     (e: any) => e.resource?.resourceType === "QuestionnaireResponse",
//   );
//   const bundleObservationEntries = resource.entry.filter(
//     (e: any) => e.resource?.resourceType === "Observation",
//   );

//   if (
//     bundleQuestionnaireEntry === undefined ||
//     bundleQuestionnaireResponseEntry === undefined
//   ) {
//     issues.push({
...
//     });
//   }
//   const questionnaireWithErrorMessages =
//     bundleQuestionnaireEntry !== undefined
//       ? normalizeQuestionnaire(bundleQuestionnaireEntry.resource)
//       : undefined;
//   const questionnaireIssues = questionnaireWithErrorMessages?.issues;
//   const questionnaire = questionnaireWithErrorMessages?.data;
//   const questionnaireResponseWithErrorMessages =
//     bundleQuestionnaireResponseEntry !== undefined &&
//     questionnaire !== undefined
//       ? normalizeQuestionnaireResponse(
//           bundleQuestionnaireResponseEntry.resource,
//           [questionnaire],
//         )
//       : undefined;
//   const questionnaireResponseIssues =
//     questionnaireResponseWithErrorMessages?.issues;
//   const questionnaireResponse = questionnaireResponseWithErrorMessages?.data;
//   const observationsWithErrorMessages =
//     bundleObservationEntries !== undefined
//       ? bundleObservationEntries.map((entry: any) =>
//           normalizeObservation(entry.resource),
//         )
//       : undefined;
//   const observationIssues = observationsWithErrorMessages
//     ?.map((observation: any) => observation.issues)
//     .flat();
//   const observations = observationsWithErrorMessages?.map(
//     (observation: any) => observation.data,
//   );
