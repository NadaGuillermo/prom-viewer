        ...
        <div className="tw:fixed tw:inset-0 tw:flex tw:items-center tw:justify-center tw:z-50">
          ...
          <div className="tw:relative tw:bg-base-100 tw:p-6 tw:rounded-xl tw:shadow-xl tw:z-10 tw:w-96 tw:max-h-[80vh] tw:flex tw:flex-col">
            ...
            <div className="tw:overflow-y-auto tw:flex-1 tw:px-4">
              ...
              {data.map((issue) => (
                issue.level === "error" && (
                  <div key={issue.id} role="tw:alert" className="tw:alert tw:alert-error tw:alert-outline tw:mb-2">
                    <p>
                      {issue.message}
                    </p>
                  </div>           
              ...
              {data.map((issue) => (
                issue.level === "warning" && (
                  <div key={issue.id} role="tw:alert" className="tw:alert tw:alert-warning tw:alert-outline tw:mb-2">
                <p>
                  {issue.message}
                </p>
                </div>
